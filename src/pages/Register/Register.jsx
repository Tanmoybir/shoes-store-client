...
const Register = () => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault()
        console.log(userName, image, email, password);
    }
    return (
        <div>
                    ...
                    <div className="w-full sm:w-1/2 mb-8 sm:mb-0">
                        ...
                        <form onSubmit={handleSubmit}>
                            <div className="flex flex-col space-y-4 mb-4">
                                <input onBlur={(e) => setUserName(e.target.value)} className="flex h-10 w-full rounded-md border px-3 py-2 text-sm focus:outline-none" placeholder="Username" type="text" />
                                <input onBlur={(e) => setImage(e.target.value)} className="flex h-10 w-full rounded-md border px-3 py-2 text-sm focus:outline-none" placeholder="Image" type="url" />
                                <input onBlur={(e) => setEmail(e.target.value)} className="flex h-10 w-full rounded-md border px-3 py-2 text-sm focus:outline-none" placeholder="Email" type="email" />
                                <input onBlur={(e) => setPassword(e.target.value)} className="flex h-10 w-full rounded-md border px-3 py-2 text-sm focus:outline-none" placeholder="Password" type="password" />
                            </div>
