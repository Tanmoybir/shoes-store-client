                    ...
                    <div className="w-full sm:w-1/2 mb-8 sm:mb-0">
                        ...
                        <form onSubmit={handleSubmit}>
                            <div className="flex flex-col space-y-4 mb-4">
                                <input onBlur={(e) => setEmail(e.target.value)} className="flex h-10 w-full rounded-md border px-3 py-2 text-sm focus:outline-none" placeholder="Username" type="text" />
